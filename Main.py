...
# =============================================================================
        ...
        OBSERVATION_DISEASE_LBL = QtWidgets.QLabel("Observation : ")
        ...
        DISEASE_GRIDBOX.addWidget(TREATMENT_DISEASE_LBL,1,0)
        DISEASE_GRIDBOX.addWidget(self.TREATMENT_DISEASE_TE,1,1)
        DISEASE_GRIDBOX.addWidget(OBSERVATION_DISEASE_LBL,2,0)
        DISEASE_GRIDBOX.addWidget(self.OBSERVATION_DISEASE_TE,2,1)
